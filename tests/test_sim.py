...
class FooFromNpz_dds_syn(FooConfig):
    def __init__(self, npz_path, N_ddp = 5, default_r = 10.0):
        ...
        is_dynamic['connectors']['dummy_delay']['tau_d'] = False
        is_dynamic['connectors']['dummy_delay']['tau_r'] = False
        is_dynamic['connectors']['dummy_delay']['weight'] = False
        is_dynamic['connectors']['dummy_delay']['slope'] = False
        is_dynamic['connectors']['dummy_delay']['bias'] = False
